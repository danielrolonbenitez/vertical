...
<div class="panel-primary col-xs-12">
  ...
  <div class="panel-primary col-xs-12" id="ubicacion">
    ...
    <div style="background-color: white;">
      <iframe width="100%" height="450" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?q={{$edificio->direccion}}%20Castelar%20Buenos%20Aires%20Argentina&amp;key=AIzaSyCPpkhmh7Ztzg6bmrBNYM18aurw9ktWFQE" allowfullscreen></iframe> 
    </div>
  </div>
</div>
