...
<div class="tab-content">
 @if (count($errors) > 0)
  ...
  @endif
  <form method="POST" action="{{ route('gastos.store') }}" data-toggle="validator">
    {{ csrf_field() }}
    <input type="hidden" name="edificio_id" value="<?php echo $_GET['id'] ?>">
    <div class="panel-primary col-xs-12">
      <div class="panel-heading col-xs-12 form-inline">
        <div class="pull-left">
          <h2 class="panel-title">Nuevo Gasto</h2>
        </div>
      </div>
      <div class="panel-body col-xs-12">
        <div class="row">
          <div class="form-group col-md-6">
            ...
            <div class="col-md-8"> 
              <input required id="fecha" name="fecha" class="form-control" type="text" data-error="*Campo obligatorio">
          ...
          <div class="form-group col-md-6">
            ...
            <div class="col-md-8">  
              <input autocomplete="off" required id="q" name="descripcion" class="form-control" type="text" data-error="*Campo obligatorio">
              <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
              <div class="help-block with-errors"></div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="form-group col-md-6">
            ...
            <div class="col-md-8"> 
              <input required id="comprobante" name="comprobante" class="form-control" type="text" data-error="*Campo obligatorio">
              <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
              <div class="help-block with-errors"></div>
            </div>
          </div>
          <div class="form-group col-md-6">
            ...
            <div class="col-md-8"> 
              <input required id="importe" name="importe" class="form-control" type="number" step="0.01" data-error="*Campo obligatorio">
              <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
              <div class="help-block with-errors"></div>
            </div>
          </div>
