    ...
    <div class="panel-body col-xs-12">
      <div class="row">
        ...
        <div class="form-group col-md-6 has-feedback">
          ...
          <div class="col-md-8">  
            <input data-remote="{{ route('validate.edificiocuit') }}" data-remote-error="*CUIT registrado" value="{{ $edificio->cuit }}" required id="cuit" name="cuit" class="form-control" type="number" max=2147483647 data-error="*Campo obligatorio">
            <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
            <div class="help-block with-errors"></div>
          </div>
        </div>
        ...
        <div class="form-group col-md-6 has-feedback">
          ...
          <div class="col-md-8"> 
            <select id="admin_id" name="admin_id" class="form-control input-md">
              @foreach ( $admins as $a )
              <option value="{{ $a->id }}" @if ( $a->id == $admin->id ) selected @endif>{{ $a->razon_social }}</option>
              @endforeach
            </select>
            <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
            <div class="help-block with-errors"></div>
