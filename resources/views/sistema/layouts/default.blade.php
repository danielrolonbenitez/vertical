    ...
    <div class="row">
      <div class="col-sm-3 col-md-2 sidebar" id="navbar2" style="background-color:white;">
        <ul class="nav nav-sidebar filterable" style="background-color:white;">
          <li @if ( Request::is('*dashboard*') ) class="active" @endif><a href="{{ route('sistema.dashboard') }}"><span class="glyphicon glyphicon-home"></span> Inicio</a></li>
          ...
          <li @if ( Request::is('admins*') ) class="active" @endif><a href="{{ route('admins.index') }}"><span class="glyphicon glyphicon-user"></span> Administradores</a></li>
          ...
          <li @if ( Request::is('contactos*') ) class="active" @endif><a href="{{ route('contactos.index') }}"><span class="glyphicon glyphicon-envelope"></span> Mensajes</a></li>
        </ul>
      </div>
